            ...
            data=[
                ReadPostsResponse.Data(
                    ...
                    links=[
                        Link(
                            rel="self",
                            href=f"{request.base_url}v1/posts/{post_to_read.id}",
                        ),
                        Link(
                            rel="comments",
                            href=f"{request.base_url}v1/comments?post_id={post_to_read.id}",
                        ),
                        Link(
                            rel="feedbacks",
                            href=f"{request.base_url}v1/feedbacks/posts?post_id={post_to_read.id}",
                        ),
                    ],
                )
